...
?>
                         <div class="tab flex w-full justify-center bg-white border-1 border-blue-500 p-2 ">
                            ...
                            <div  class="paid pt-2">
                                 <a href="paid.php" class="tabs border-2 border-green-600 p-2 px-5 bg-green-600 text-gray-700 hover:text-white">paid</a>
                            </div>
                ...
                <div class="tab-contents records w-full p-2 bg-white">
                    <?php
$sql1 = "SELECT * FROM withdrawals WHERE pay_condition = 'Paid' ORDER BY draw_date DESC ";
