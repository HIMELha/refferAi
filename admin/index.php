    ...
    <div class="container m-auto bg-white h-screen">
        ...
        <section class="flex justify-between gap-4 bg-gradient-to-tr from-red-100 to-cyan-200 w-full max-h-fit min-h-full p-2 pl-4 pr-4 ">
            ...
            <div class="mt-5 flex flex-col justify-between gap-2">
                <a href="index.php" class="text-sm w-full p-2 px-4 outline outline-1 outline-sky-500 text-white bg-sky-400 hover:text-white rounded-sm"><i class="fa-solid fa-star mr-2"></i></i>premium users</a>
                ...
                <a href="withdrawals.php" class="text-sm w-full p-2 px-4 outline outline-1 outline-sky-500 text-blue-700  bg-white hover:bg-sky-500 hover:text-white rounded-sm"><i class="fa-solid fa-money-bill mr-2"></i>withdrawal record</a>
            </div>
            </div>

            <div class="earnings w-[900px] p-4 bg-gradient-to-tr from-gray-600 to-blue-400 ">
                <div class=" p-4">
                     <p class="text-[20px] py-2 text-center pl-4 text-blue-200">premium users</p>
                    <div class="flex flex-col items-center gap-2">
                        <h2 class="p-2 px-4 bg-white ">alexis buy premium with 50 BDT </h2>
                        <h2 class="p-2 px-4 bg-white ">alexis buy premium with 50 BDT </h2>
                        <h2 class="p-2 px-4 bg-white ">alexis buy premium with 50 BDT </h2>
                        <h2 class="p-2 px-4 bg-white ">alexis buy premium with 50 BDT </h2>
                        <h2 class="p-2 px-4 bg-white ">alexis buy premium with 50 BDT </h2>
