    ...
    <div class="container m-auto bg-white h-screen">
        ...
        <section class="flex justify-between gap-4 bg-gradient-to-tr from-red-100 to-cyan-200  w-full max-h-fit min-h-full p-2 pl-4 pr-4 ">
            ...
            <div class="mt-5 flex flex-col justify-between gap-2">
                ...
                <a href="withdrawals.php" class="text-sm w-full p-2 px-4 outline outline-1 outline-sky-500 text-blue-700  bg-green-300  hover:bg-sky-400 hover:text-white rounded-sm"><i class="fa-solid fa-money-bill mr-2"></i>withdrawal record</a>
            </div>
            </div>

            <div class="earnings w-[1000px] p-4 bg-gradient-to-tr from-gray-600 to-blue-400">
                <div class=" p-4">
...
?>
                         <div class="tab flex w-full justify-center bg-white border-1 border-blue-500 p-2 ">
                            ...
                            <div class="rejected pt-2">
                                 <a href="reject.php" class="tabs border-2 border-red-600 p-2 px-5 hover:bg-red-600 text-gray-700 hover:text-white">rejected</a>
                            </div>
                         </div>

                <div class="tab-contents records w-full p-2 bg-white">
                    <?php
$sql1 = "SELECT * FROM withdrawals  WHERE pay_condition = 'Processing' ORDER BY draw_date DESC ";
    ...
    while ( $row1 = mysqli_fetch_assoc( $run1 ) ) {
        ...
        ?>
                        ...
                        if($row1['pay_condition'] == 'Processing'){
                            ?>
                        <div class="flex">
                            <a href="paided.php?id=<?php echo $row1['id'];?>" class="text-green-700 process bg-gray-100 px-2 ml-2 p-1">Pay success</a>
                            <a href="rejected.php?id=<?php echo $row1['id'];?>" class="text-red-500 process bg-gray-100 px-2 ml-2 p-1">Reject</a>
                        </div>
                        <?php
        ...
        ?>
                    ...
                    <?php }
                        ...
                        echo "<p class='text-center p-3'>nothing here..</p>";
                    }
                    ?>
